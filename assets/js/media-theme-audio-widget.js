...
(function( component ) {
	...
	AudioWidgetControl = component.MediaWidgetControl.extend({
		...
		renderPreview: function renderPreview() {
			...
			previewTemplate = wp.template( 'wp-media-widget-theme-audio-preview' );
		...
		editMedia: function editMedia() {
			...
			mediaFrame.state( 'theme-audio-details' ).on( 'update', updateCallback );
	...
	// Exports.
	component.controlConstructors.theme_audio_widget = AudioWidgetControl;
	component.modelConstructors.theme_audio_widget = AudioWidgetModel;
